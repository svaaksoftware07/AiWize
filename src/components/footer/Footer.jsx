  ...
  return (
    <div className=" bg-black text-gray-400 flex flex-col gap-0 md:gap-20 py-4 footer ">
      <div className="flex justify-around flex-wrap footer1 pt-5">
        <div>
          <img src="assets/images/navLogo.png" alt="" className="w-32" />
        </div>
      ...
      <div className="flex flex-wrap md:justify-around footer2">
        ...
        <div className="footer-bottom-text pl-[15px] border-b-2 md:border-b-0  md:border-l-2 border-[#FFDA14] ">
          <h4> Asia HQ </h4>
          <p>1108 Mahagun Maple</p>
          <p>F-26, Sector 50, Noida, UP- 201 301</p>
          <p>PH: +91 9818258199</p>
        </div>
        <div className="footer-bottom-text pl-[15px] md:border-l-2 md:border-[#FFDA14]">
          <h4> USA HQ </h4>
