...
const ProductPageVideo = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-black text-white py-10">
      <div className="relative h-[50vh] sm:h-[50vh] w-full md:w-1/2">
        <img src="/assets/images/chankaya/ProductPageVideo.png" alt="" className="absolute z-10 top-5 left-[16%] w-[65%] rounded-sm opacity-70 md:left-[25%] md:w-[65%]"/>
        <img src="/assets/images/chankaya/ProductPageVideo.png" alt="" className="absolute z-20 top-10 left-[22%] w-[65%] rounded-sm opacity-80 md:left-[28%] md:w-[65%]"/>
        <img src="/assets/images/chankaya/ProductPageVideo.png" alt="" className="absolute z-30 top-14 left-[26%] w-[65%] rounded-sm opacity-100 md:left-[31%] md:w-[65%]"/>
      </div>


      <div className="w-full md:w-[50%] flex flex-col justify-center gap-5 px-[10vw] md:px-[5vw] py-10">
        <div>
