  ...
  return (
    <div className="container mx-auto py-8 pt-36">
      <div className="w-[90vw] md:w-[70vw] mx-auto">
        <h1 className="text-3xl font-bold mb-4 w-fit mx-auto text-center border-b-2 border-black">Privacy Policy</h1>
        <div className="text-lg text-justify">
          <p>
            AiWizelabs PVT LTD operates www.aiwizelabs.com. This page informs you of our policies regarding the collection, use, and disclosure of Personal Information we receive from users of the Site.
          </p>
          <p>
          ...
          <h2 className="text-xl font-bold mt-8 mb-4">Log Data</h2>
          <p>
