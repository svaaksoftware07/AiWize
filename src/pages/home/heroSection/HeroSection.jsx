...
function HeroSection() {
    ...
    return (
        <div className="hero-section-main text-white">
                        ...
                        <div className="md:p-10 w-screen md:w-[48%] flex items-center justify-center">
                            <div className="my-8 md:mt-10">
                                ...
                                <div className='hero-section-text'>
                                    ...
                                    <p >{data[index].description2}<span className='text-lg flex items-start mx-1 '>{data[index]?.span2}</span>{data[index]?.description3}</p>
                                </div>
                            </div>
                        </div>

                        <div className='hero-section-group-two-inner-two-button'><span className=' w-[100px] md:w-[200px] bg-[var(--yellow)] button md:h-12  text-black'>Explore Now</span></div>
                    </div>
                </div>
            </div>
        </div>
