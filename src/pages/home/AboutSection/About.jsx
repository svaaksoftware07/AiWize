...
function About() {
    return (
        <>
            {/* About */}
            <div className="flex justify-center text-center bg-[url(assets/gif/home/aboutGif.gif)] bg-cover md:h-screen ">
                <div className="py-16 text-center w-screen bg-[#36373385] flex items-center">
                    <div>
                        ...
                        <div className="flex justify-center my-5">
                            <p className='text-center px-3 text-[15px] md:w-3/5 md:text-[1.3rem] text-white md:leading-8 mb-3'>
