...
const RecentBlog = () => {
  ...
  return (
    <div className="flex flex-col justify-start mt-10 items-center h-auto pb-20 md:pb-10 lg:pb-5 md:h-auto lg:h-screen BlogGradient mb-7 md:mb-10">
      ...
      <div className="flex items-center justify-center gap-6">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center h-auto">
          <div className="w-full md:w-1/2 bg-white text-black py-6 px-2 lg:p-10 flex flex-col text-center h-[350px] md:text-left items-center md:items-start overflow-hidden">
          ...
          <img src={blogData[index]?.image} alt="" className="w-full hidden md:block md:w-1/2 h-[350px]" />
        </div>
