  ...
  return (
    <>
      ...
      <div className="product-hero-section-main text-white overflow-x-hidden">
        <div
          className={`blog-bg-main bg-[url(/images/blog/BannerHeroVideo.png)]  bg-cover bg-no-repeat w-screen h-screen md:h-[750px] xl:h-screen z-[-1]`}
        >
          <div className="product-hero-section-group-one">
            <div className="">
              <p className="text-3xl text-center mb-10">Let’s Check</p>
              <div className="flex items-center">
                <h3 className="product-hero-section-heading text-center">
                  WHAT’S NEW
                </h3>
